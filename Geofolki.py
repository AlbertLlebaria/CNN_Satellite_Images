...
optical = rasterio.open('data/train_val/train/tile_328_rgb.tif')
...
DEM = rasterio.open('data/train_val/train/tile_328_mask.tif')
DEM_data = DEM.read([1])
...
u, v = GEFolki(DEM_data, Ioptical_data, iteration=2,
               radius=range(4, 16, -4), rank=16, levels=2)
...
print("Fin recalage optique/Radar \n\n")
with rasterio.open('building_4_32_4_2.tif', 'w', **data_profile) as dst:
    dst.write(res)
