...
class BN_NET:
    def __init__(self, drop_rate=DRORATE, learning_rate=LEARNING_RATE, model_dir=MODEL_DIR):
          ...
          self.optimizer = keras.optimizers.Adam(learning_rate=self.learning_rate, beta_1=0.9, beta_2=0.999, amsgrad=False)
    ...
    def train(self):
        ...
        checkpoint = ModelCheckpoint(self.filepath, monitor='val_accuracy', verbose=1, save_best_only=True, mode='max') 
        ...
        for r in ranges:
            ...
            #LOAD DATA
            file_list = glob.glob(os.path.join(DATA_DIR, TRAIN_DIR,"*_mask.tif" ))
    ...
    def load_weights(self, weights_file):
        try:
            ...
            print(f"Failed loading {os.path.join(CHECK_POINT_PATH,weights_file)}")
            print(f"Error: {e}")
            pass
